...
function showWelcomePopup() {
  const imageUrl = "assets/img/welcome.jpg"; // Simpan URL gambar dalam variabel
  const confirmButtonText = "Coba Sekarang!";

  Swal.fire({
    title: "Selamat Datang di Bookself!",
    text: "Kelola Buku jadi lebih mudah hanya di Bookself",
    imageUrl,
    imageWidth: 200,
    imageHeight: 200,
    imageAlt: "Gambar Buku",
    ...
    if (result.isConfirmed) {
      // Lakukan sesuatu ketika tombol "Coba Sekarang!" diklik
      console.log('Pengguna mengklik "Coba Sekarang!"');
    }
  });
}
